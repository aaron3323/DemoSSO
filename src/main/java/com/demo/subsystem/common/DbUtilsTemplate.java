...
public class DbUtilsTemplate {
	private final Log log = LogFactory.getLog(DbUtilsTemplate.class);
    ...
    public int[] batchUpdate(String sql, Object[][] params) { 
        ...
        try { 
        		connection = DataSourceUtils.getConnection(getDataSource());
            affectedRows = queryRunner.batch(connection, sql, params); 
        } catch (SQLException e) { 
    ...
    public List<Map<String, Object>> find(String sql, Object[] params) { 
        ...
        try { 
        	Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
            if (params == null) { 
                list = (List<Map<String, Object>>) queryRunner.query(connection, sql, new MapListHandler()); 
            } else { 
                list = (List<Map<String, Object>>) queryRunner.query(connection, sql, new MapListHandler(), params); 
            } 
        } catch (SQLException e) { 
    ...
    public <T> T findFirst(Class<T> entityClass, String sql, Object[] params) { 
        ...
        try { 
        	Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
            if (params == null) { 
                object = queryRunner.query(connection, sql, new BeanHandler(entityClass)); 
            } else { 
                object = queryRunner.query(connection, sql, new BeanHandler(entityClass), params); 
            } 
        } catch (SQLException e) { 
            log.error("Error occured while attempting to query data", e); 
            throw new RuntimeException(e.getMessage(), e);
    ...
    public Map<String, Object> findFirst(String sql, Object[] params) { 
        ...
        try { 
        	Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
            if (params == null) { 
                map = (Map<String, Object>) queryRunner.query(connection, sql, new MapHandler()); 
            } else { 
                map = (Map<String, Object>) queryRunner.query(connection, sql, new MapHandler(), params); 
            } 
        } catch (SQLException e) { 
            log.error("Error occured while attempting to query data", e); 
            throw new RuntimeException(e.getMessage(), e);
	...
	public Object findBy(String sql, int columnIndex, Object[] params) { 
        ...
        try { 
        		Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
            if (params == null) { 
                object = queryRunner.query(connection, sql, new ScalarHandler(columnIndex)); 
            } else { 
                object = queryRunner.query(connection, sql, new ScalarHandler(columnIndex), params); 
            } 
        } catch (SQLException e) { 
            log.error("Error occured while attempting to query data", e); 
            throw new RuntimeException(e.getMessage(), e);
	...
	public List<Object> findListBy(String sql, Object param) { 
        List<Object> list = null; 
        try { 
    			Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
            if (param == null) { 
                list = queryRunner.query(connection, sql, new ColumnListHandler<>()); 
            } else { 
                list = queryRunner.query(connection,sql,param,new ColumnListHandler<>());
            } 
        } catch (SQLException e) { 
            log.error("Error occured while attempting to query data", e); 
            throw new RuntimeException(e.getMessage(), e);
     ...
     */
    @SuppressWarnings("deprecation")
    public List<Object> findListBy(String sql, Object[] params) { 
    	List<Object> list = null; 
    	try { 
        	Connection connection = DataSourceHelper.getReadOnlyConnection(getDataSource());
    		if (params == null || params.length == 0) { 
    			...
    			list = queryRunner.query(connection,sql,params,new ColumnListHandler<>());
    		} 
    	} catch (SQLException e) { 
    		log.error("Error occured while attempting to query data", e); 
			throw new RuntimeException(e.getMessage(), e);
